...
const VideoUpload = (props) => {
  ...
  function addParagraphTags(text) {
    console.log(text);
    text = "Lam Uong\nhttps://github.com/LamUong | Vancouver, Canada | lam.uong2@mail.mcgill.ca\nEducation\n\nB.S c. Computer Science and Biology\nMcGill University, Montreal, QC\n\n2013 – 2017\nCGPA: 3.7 / 4.0\n\nWork Experiences\n\nGoogle\nSoftware Engineer\nI work on Machine Learning for age inferences across all Google accounts and sign-out spaces for\nregulation purposes. My work spans data science, machine learning and software engineering.\nA few things I have done:\n\n2022 - 2023\n\n● Established standards for evaluating new signals for modelling\n● Created infrastructure to automate the process of new signals evaluation\n● Created infrastructure to monitor and ensure pipeline stability\n● Built mechanism to allow user re-inferences\n\nBesides my core work, I provide technical help, insights and directions for other engineers within my\nteam and cross-team collaborations.\n\nGoogle\nSoftware Engineer\nI work in the EngEdu team building education software.\nI am also part of a 20% project on Drug Discovery using Machine Learning too.\n\n2019 - 2022\n\nKeela\nSoftware Engineer\nConduct research, generate ideas, build prototypes and offline/online tests for production machine\nlearning systems serving non profit organisations.\n\n2018 - 2019\n\nEricsson\nSoftware Developer\nContribute to a content management tool implementation.\nImplemented recommendation system to suggest engineers to troubleshoot tickets and develop\nquestion answer systems from ticket data.\n\n2017 - 2018\n\nSide Project\n\nFacial Expressions Recognition\nCreate an Expression Recognition AI in Keras that achieved 70% accuracy for FER-2013 dataset.\n\nSkills\n\nLanguages: Python, Java, C++, Javascript/Typescript, HTML, CSS.\nMachine Learning: Tensorflow, Pytorch, Keras, Scikit Learn, Numpy, Pandas, Colab.\n\n\f";
